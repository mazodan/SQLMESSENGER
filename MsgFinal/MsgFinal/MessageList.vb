Public Class MessageList
    ...
    Private Sub lvMessageBox_ItemActivate(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvMessageBox.ItemActivate
        ...
        viewMessage(MessageContent.rtfInfo, lvMessageBox.Items.Item(lvMessageBox.FocusedItem.Index).SubItems.Item(2).Text + CurUser, lvMessageBox.FocusedItem.Text, False)
    ...
    Private Sub MessageList_VisibleChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.VisibleChanged
        AddMessageToListview(lvMessageBox, False)
    End Sub
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        searchMessages(txtSearch.Text, lvMessageBox, False)
    End Sub

    Private Sub btnDSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDSearch.Click
        searchByDate(Convert.ToString(dtpDate.Value.Date), lvMessageBox, False)
    End Sub

    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If lvMessageBox.SelectedItems.Count > 0 Then
            DeleteMessage(lvMessageBox.FocusedItem.Text, False)
            AddMessageToListview(lvMessageBox, False)
        End If
    End Sub

    Private Sub lvMessageBox_VisibleChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvMessageBox.VisibleChanged
        AddMessageToListview(lvMessageBox, False)
    End Sub
End Class